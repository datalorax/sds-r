...
we will have no problem creating dummy variables as long as the levels of $f$ are within those contained in `df$f` (or, more mathematically, where $f \in E$). But what if, in a new sample, $e =$ "purple" or $e =$ "gray"? Let's try and see what happens
...
#### Encoding and imputing missing data
...
Just a slight step up in complexity from omission of rows with missing data is to impute them with sample descriptive statistics, such as the mean or the median. 
