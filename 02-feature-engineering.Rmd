...
There are many different options for modeling curvilinnear relations, but we'll focus on two: [basis expansion](https://towardsdatascience.com/non-linear-regression-basis-expansion-polynomials-splines-2d7adb2cc226) via polynomial transformations and natural splines.
