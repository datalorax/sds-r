...
```{r echo = FALSE}
tune_tree_lr_tm <- readRDS(here::here("models", "xgboost",  "tune_tree_lr_tm.Rds"))
```
...
```{r echo = FALSE}
tune_tree_lr_xgb <- readRDS(here::here("models", "xgboost",  "tune_tree_lr_xgb.Rds"))
```
...
```{r echo = FALSE}
tune_treedepth_tm <- readRDS(here::here("models", "xgboost",  "tune_treedepth_tm.Rds"))
```
...
```{r echo = FALSE}
tune_lossred_tm <- readRDS(here::here("models", "xgboost",  "tune_lossred_tm.Rds"))
```
...
```{r echo = FALSE}
tune_stoch_tm <- readRDS(here::here("models", "xgboost",  "tune_stoch_tm.Rds"))
```
